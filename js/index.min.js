...
$(".close-customize, #zhezhao").click(function() {
    ...
    if (closeData !== loadData) {
        layer.confirm("您修改的内容还未保存，确定要退出吗？", {
            btn: ["确定", "取消"]
        }, function(index) {
            location.reload()
        })
    ...
    if (!ifLogin) {
        $.ajax({
            ...
            headers: {
                ...
                "X-SS-API-KEY": "8a32a681-724a-4c2b-8e57-a7af37b48260"
            },
            data: JSON.stringify({
                "customContext": getCustomData()
            }),
            success: function() {
                localSave()
            },
...
function submitLogin() {
    ...
    if (retVal[1] && retVal[0][1].value.length >= 6) {
        $.ajax({
            ...
            data: JSON.stringify({
                "account": retVal[0][0].value,
                "password": md5(retVal[0][1].value)
            }),
            success: function(res) {
